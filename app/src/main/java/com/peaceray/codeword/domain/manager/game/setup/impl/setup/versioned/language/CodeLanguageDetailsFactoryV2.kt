 ...
 */
internal class CodeLanguageDetailsFactoryV2: CodeLanguageDetailsFactory(SeedVersion.V2) {
        ...
        if (details == null) {
            ...
            details = when (language) {
                CodeLanguage.ENGLISH -> CodeLanguageDetails(
                    ...
                    (3..12).toList(),
                    listOf(26),
                    codeCharacterRepetitionsSupported = listOf(0, 1)
                )
